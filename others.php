                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="subActivity" name="subActivity">
                                    ...
                                    <option value="industrial_visits">Co-conducting/co-ordinating of NSS activities</option>
                                    ...
                                    <option value="academic_clubs_committee">Arranging/Co-ordinating skits/drama/plays</option>
                                    <option value="debates_presentations">Arranging/Co-ordinating/Preparing students (for) Cultural Events in MU</option>
                                    <option value="internships">Preparing/Accompanying Students for External Cultural Events</option>
                                    <option value="exchange_programs">Arranging/Accompanying Students for External Cultural Events</option>
                                    <option value="preparing_students_events">Arranging/co-ordinating/accompaying treking exceptional/fun excurions</option>
                                    <option value="career_counseling">Conducting/arranging like skills related/events Eg. First aid, Tailoring, Cooking, etc</option>
                                    <option value="competitive_exams">Preparing/Accompanying Students for/in national/international competitions/events</option>
