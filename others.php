...
$sql = "SELECT * FROM others WHERE employee_id = '{$_SESSION['employee_id']}'";
...
<body>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Others Detail</h5>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="mainActivity" name="mainActivity">
                                    <option value="other_co_curricular_activities">Other Co-curricular Activities
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="subActivity" name="subActivity">
                                    ...
                                    <option value="industrial_visits">Co-ordination </option>
                                    <option value="industrial_visits">Co-conducting/co-ordinating of NSS activities
                                    </option>
                                    <option value="remedial_classes">Co-conductination of NCC activities</option>
                                    <option value="special_classes">Arranging/Co-ordinating sports competitions
                                    </option>
                                    <option value="academic_clubs_committee">Arranging/Co-ordinating skits/drama/plays
                                    </option>
                                    <option value="debates_presentations">Arranging/Co-ordinating/Preparing students
                                        (for) Cultural Events in MU</option>
                                    <option value="internships">Preparing/Accompanying Students for External Cultural
                                        Events</option>
                                    <option value="exchange_programs">Arranging/Accompanying Students for External
                                        Cultural Events</option>
                                    <option value="preparing_students_events">Arranging/co-ordinating/accompaying
                                        treking exceptional/fun excurions</option>
                                    <option value="career_counseling">Conducting/arranging like skills related/events
                                        Eg. First aid, Tailoring, Cooking, etc</option>
                                    <option value="competitive_exams">Preparing/Accompanying Students for/in
                                        national/international competitions/events</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Add Others Detail</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="editForm" action="cat2_others_update.php" method="POST" enctype="multipart/form-data">
