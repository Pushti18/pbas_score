        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Form fields go here -->
                    <form id="myForm" action="cat2_extension_insert.php" method="POST">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="mainActivity" name="mainActivity">
                                    ...
                                    <option value="Extensiona_and_dissemination_activities">Extensiona and dissemination activities</option>
