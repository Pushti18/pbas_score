...
while ($row = $result->fetch_assoc()) {
    ...
    $publication = "SELECT region, type, role, publication_group,current_status_of_work,co_author
                    FROM publication
                    WHERE employee_id = " . $_SESSION['employee_id'] . " AND cat3_id = 'cat3'";
    // echo ($discipline);
    ...
    $direct_teaching = "SELECT university,degree,projectType,statusofwork,points
                    ...
                    WHERE employee_id = " . $_SESSION['employee_id'] . " AND cat1_id = 'cat1'";
    ...
    <div class="main_div">
            ...
            <tbody>
                <?php foreach ($data as $row): ?>
                    <tr>
                        ...
                        <td> <button id="btn-generate" data-sr-no="<?= $row['id'] ?>">Generate PDF</button></td>
        ...
        <script>
            ...
            buttonElement.addEventListener('click', function () {
                ...
                var disciplineData = data[0].disciplineData;
                var othercocurricularData = data[0].othercocurricularData;
                var extensionData = data[0].extensionData;
                var administrativeData = data[0].administrativeData;
                var participationData = data[0].participationData;
                var othersData = data[0].othersData;
                var development_activitiesData = data[0].development_activitiesData;
                var publicationData = data[0].publicationData;
                ...
                var researchData = data[0].researchData;
                ...
                var project_outputData = data[0].project_outputData;
                ...
                var guidanceData = data[0].guidanceData;
                ...
                var fellowshipData = data[0].fellowshipData;
                ...
                var expertData = data[0].expertData;
                ...
                var developmentData = data[0].developmentData;
                ...
                var direct_teachingData = data[0].direct_teachingData;
                ...
                var exam_dutiesData = data[0].exam_dutiesData;
                ...
                var learning_methodologiesData = data[0].learning_methodologiesData;
                ...
                var coursesData = data[0].coursesData;
                ...
                var mentoringData = data[0].mentoringData;
                ...
                var docDefinition = {
                    content: [
                        ...
                        { text: 'The total points achieved are ' + data[0].total_achieved + ' out of a target of ' + data[0].target_score + '.', style: 'pdfContent' },
                        { text: 'Category 1 Performance: ' + data[0].cat1_total_points, style: 'pdfContent', margin: [0, 10, 0, 10] },
                        { text: 'Category 2 Performance: ' + data[0].cat2_total_points, style: 'pdfContent', margin: [0, 10, 0, 10] },
                        { text: 'Category 3 Performance: ' + data[0].cat3_total_points, style: 'pdfContent', margin: [0, 10, 0, 10] },
                        {
                            canvas: [
