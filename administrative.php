...
$sql = "SELECT * FROM administrative WHERE employee_id = '{$_SESSION['employee_id']}'";
...
<body>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Administrative Detail</h5>
                ...
                <div class="modal-body">
                    <form id="myForm" action="cat2_administrative_insert.php" method="POST"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="mainActivity" name="mainActivity">
                                    <option value="Administrative_responsibility">Administrative responsibility</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="subActivity" name="subActivity">
                                    ...
                                    <option value="Program co-ordinator">Program co-ordinator</option>
                                    <option value="Chair person">Chair person</option>
                                    <option value="Convener">Convener</option>
                                    <option value="Faculty in-change">Faculty in-change</option>
                                    <option value="Admissions">Admissions</option>
                                    <option value="Exam Duty">Exam Duty</option>
                                    <option value="Accredition">Accredition</option>
                                    <option value="Co-ordinator">Co-ordinator</option>
                                    <option value="Lab/Workshop development">Lab/Workshop development</option>
                                </select>
                            </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Add Administrative Detail</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="editForm" action="cat2_administrative_update.php" method="POST"
                        enctype="multipart/form-data">
    ...
    <script>
        $(document).ready(function () {
            $('.btn-edit').click(function () {
                ...
                $.ajax({
                    type: "GET",
                    url: "cat2_administrative_update.php",
                    data: {
                        entry_id: entryId
                    },
