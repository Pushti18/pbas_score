...
<body>
    ...
    <div class="nav_div" style="background-color: lightblue;">
        <h2 style="margin-left: 42%;">Fellowships / Awards</h2>
    </div>
    <br>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="myForm" action="cat3_fellowship_insert.php" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="awardFellowshipCopy">Award/Fellowship Copy:</label>
                                <input type="file" class="form-control" id="awardFellowshipCopy"
                                    name="awardFellowshipCopy" accept=".pdf">
                            </div>
                        </div>
