...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // if (move_uploaded_file($attachment_tmp, $targetFile)) {
        ...
        //         mysqli_query($conn, $sql);
                $sql = "INSERT INTO discipline (employee_id, pbasYear, mainActivity, subActivity, activityTitle, briefRole, semester, hoursSpentAnswerBook, attachment, description, points, category_id, subcategory_id)
                VALUES ('{$_SESSION['employee_id']}', '$pbasYear', '$mainActivity', '$subActivity', '$activityTitle', '$briefRole','$semester', '$hoursSpentAnswerBook', '$attachment', '$description','$points', '$fetched_category_id', '$fetched_subcategory_id')";
            mysqli_query($conn, $sql);
