...
<body>
    ...
    <div class="nav_div" style="background-color: lightblue;">
        <h2 style="margin-left: 42%;">Mentoring</h2>
    </div>
    <br>
                ...
                <div class="modal-body">
                    ...
                    <form id="myForm">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="courseName">Name of Mentor:</label>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="detailofuploadedsubject">Name of Students:</label>
                                <input type="text" class="form-control" id="detailofuploadedsubject"
                                    name="detailofuploadedsubject">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="detailofuploadedsubject">Outcome Mentoring:</label>
                                <input type="text" class="form-control" id="detailofuploadedsubject"
                                    name="detailofuploadedsubject">
                            </div>
