...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT * FROM others WHERE employee_id = '{$_SESSION['employee_id']}' AND id = '$entryId'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE others SET pbasYear='$pbasYear', mainActivity='$mainActivity', subActivity='$subActivity', activityTitle='$activityTitle', briefRole='$briefRole', semester='$semester', hoursSpentAnswerBook='$hoursSpentAnswerBook', description='$description', points='$points' WHERE employee_id = '{$_SESSION['employee_id']}' AND id = '$entryId'";
