...
<head>
    <title>Participation Detail</title>
...
<body>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Participation Detail</h5>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Add Participation Detail</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="editForm" action="cat2_participation_update.php" method="POST"
                        enctype="multipart/form-data">
    ...
    <script>
        $(document).ready(function () {
            $('.btn-edit').click(function () {
                ...
                $.ajax({
                    type: "GET",
                    url: "cat2_participation_update.php",
                    data: {
                        entry_id: entryId
                    },
        ...
        $(document).ready(function () {
            $('.btn-delete').click(function () {
                ...
                $('#confirmDeleteBtn').click(function () {
                    $.ajax({
                        type: "POST",
                        url: "participation_delete_entry.php",
                        data: {
                            id: id
                        },
                        success: function (response) {
