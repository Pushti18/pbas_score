...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($_FILES["attachment"]["tmp_name"], $target_file)) {
        ...
        $sql = "INSERT INTO extension (cat2_id,subcat_2, employee_id, pbasYear, mainActivity, subActivity, activityTitle, briefRole, semester, hoursSpentAnswerBook, attachment, description,points)
